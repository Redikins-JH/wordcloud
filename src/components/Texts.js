...
const databaseURL ="https://wordcloud-e61bf.firebaseio.com";
...
class Texts extends React.Component {
    ...
    handleFileChange = (e) => {
        ...
        reader.readAsText(e.target.files[0], "ECU-KR");
        this.setState({
            ...
            <>
                ...
                <Dialog open={this.state.dialog} onClose={this.handleDialogToggle}>
                    ...
                    <DialogContent>
                        ...
                        <input className={classes.hidden} accept="text/plain" id="raised-button-file" type="file" file={this.state.fileName} onChange={this.handleFileChange} />
